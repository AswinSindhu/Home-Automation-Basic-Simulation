#define BLYNK_TEMPLATE_ID "TMPL3j_zTreLm"
#define BLYNK_TEMPLATE_NAME "HOME AUTOMATION"
#define BLYNK_AUTH_TOKEN "nwzQs_Asvv8o6ktpFmaIqoZp57Jme37w"
...
void loop()
{
  ...
  if(val==1)
  {
    Blynk.virtualWrite(pirinput,HIGH);
  }
  else
  {
    Blynk.virtualWrite(pirinput,LOW);
  }
}
